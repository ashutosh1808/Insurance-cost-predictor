...
def get():
	...
	em=request.form["em"]  #accepting the email
	...
	return render_template("home.html",msg="Thanks for using this! You will receive a mail shortly.") #show it on the webpage
